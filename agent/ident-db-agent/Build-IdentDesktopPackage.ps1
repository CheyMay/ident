...
foreach ($file in @('RobotSafety.ps1', 'RobotCapture.ps1', 'IdentPatientForm.ps1', 'IdentFillCheck.ps1', 'IdentFillRuntime.ps1', 'Start-IdentFillCheck.ps1', 'Start-IdentTraining.ps1')) {
